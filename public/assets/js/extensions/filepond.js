              ...
              var n = t.addFilter,
                ...
                c = function (e, t) {
                  return e.setMetadata(
                    "crop",
                    Object.assign({}, e.getMetadata("crop"), t)
                  );
                };
              return (
                ...
                n("DID_LOAD_ITEM", function (t, n) {
                  ...
                  return new Promise(function (n, i) {
                    var s = t.file;
                    if (!o(s) || !e(s) || !r("GET_ALLOW_IMAGE_CROP"))
                      return n(t);
        ...
        e.exports = (function () {
                  ...
                  if (n(o, 0) === t.JPEG) {
                    for (var a = o.byteLength, s = 2; s < a; ) {
                      ...
                      if (((s += 2), u === t.APP1)) {
                        ...
                        s += 2;
                        for (var f = 0; f < c; f++)
                          if (n(o, s + 12 * f, l) === t.Orientation)
                            return void i(n(o, s + 12 * f + 8, l));
                      } else {
          ...
          return (
            "undefined" != typeof window &&
              void 0 !== window.document &&
              document.dispatchEvent(
                new CustomEvent("FilePond:pluginloaded", { detail: c })
              ),
            c
          );
        })();
        ...
        e.exports = (function () {
          ...
          var s = function (e, t) {
            ...
            v = function (e) {
              ...
              return m(
                e,
                Object.assign({ cx: t, cy: n, rx: r, ry: i }, e.styles)
              );
            },
            ...
            D = function (e, t, n, r) {
              ...
              if (
                (m(i, { x1: f.x, y1: f.y, x2: p.x, y2: p.y }), t.lineDecoration)
              ) {
                    ...
                    if (o) {
                      ...
                      if (!_ || (_ && h)) {
                        ...
                        "force" === E
                          ...
                          : ("cover" === E
                              ? (m = Math.max(g, I))
                              : "contain" === E && (m = Math.min(g, I)),
                            (l *= m),
                            (c *= m));
                      }
                    }
                    var T = { width: s, height: u };
                    t.element.setAttribute("width", T.width),
                      t.element.setAttribute("height", T.height);
                ...
                create: function (t) {
                  ...
                  (r.width = r.image.width),
                    ...
                    (n.ref.bitmap = n.appendChildView(
                      n.createChildView(K(e), { image: r.image })
                    ));
                },
                write: function (e) {
                  var t = e.root,
              ...
              return e.utils.createView({
                ...
                didWriteView: function (e) {
                  var t = e.root,
                    n = e.props;
                  n.background &&
                    (t.element.style.backgroundColor = n.background);
                },
                create: function (t) {
                  var n = t.root,
                    r = t.props;
                  (n.ref.image = n.appendChildView(
                    n.createChildView($(e), Object.assign({}, r))
                  )),
                    (n.ref.createMarkup = function () {
                      n.ref.markup ||
                        (n.ref.markup = n.appendChildView(
                          n.createChildView(U(e), Object.assign({}, r))
                        ));
                    }),
                    (n.ref.destroyMarkup = function () {
                      n.ref.markup &&
                        (n.removeChildView(n.ref.markup),
                        (n.ref.markup = null));
                    });
                ...
                create: function (e) {
                  ...
                  ne++,
                    t.element.classList.add(
                      "filepond--image-preview-overlay-".concat(n.status)
                    ),
              ...
              self.onmessage = function (e) {
                for (
                  ...
                  (D = r[A] / 255),
                    ...
                    (r[A] = Math.max(
                      0,
                      Math.min(255 * (D * o + S * a + w * s + L * u + l), 255)
                    )),
                    (r[A + 1] = Math.max(
                      0,
                      Math.min(255 * (D * c + S * f + w * d + L * p + E), 255)
                    )),
                    (r[A + 2] = Math.max(
                      0,
                      Math.min(255 * (D * h + S * _ + w * m + L * g + I), 255)
                    )),
                    (r[A + 3] = Math.max(
                      0,
                      Math.min(255 * (D * T + S * v + w * y + L * R + O), 255)
                    ));
            ...
            pe = function (e) {
              ...
              for (var s = a.length, u = 0, l = 0, c = 0, f = 0; f < s; f += 4)
                (u += a[f] * a[f]),
                  (l += a[f + 1] * a[f + 1]),
                  (c += a[f + 2] * a[f + 2]);
              return {
              ...
              var t = re(e),
                ...
                i = function (e, t, n) {
                  return new Promise(function (i) {
                    ...
                    if (!t || 20 !== t.length)
                      return n.getContext("2d").putImageData(o, 0, 0), i();
                    var a = r(oe);
                    a.post(
                    ...
                    if (o)
                      if (/filter/.test(r.change.key)) {
                        ...
                        if (
                          ...
                          f.crop &&
                          f.crop.aspectRatio &&
                          Math.abs(c.aspectRatio - f.crop.aspectRatio) > 1e-5
                        ) {
                          var d = a({ root: t });
                      ...
                      f = function (e) {
                        ...
                        if (o && l) {
                          ...
                          var f = Math.max(1, 0.75 * window.devicePixelRatio),
                            ...
                            m = _ * p;
                          p > 1
                            ? (m = (_ = Math.min(o, E * d)) * p)
                            : (_ = (m = Math.min(l, h * d)) / p);
                          var g = le(e, _, m, r),
                            I = function () {
                              var r = t.query(
                                ...
                                ? pe(data)
                                : null;
                              a.setMetadata("color", r, !0),
                                "close" in e && e.close(),
                                (t.ref.overlayShadow.opacity = 1),
                                s({ root: t, props: n, image: g });
                            },
          ...
          return (
            "undefined" != typeof window &&
              void 0 !== window.document &&
              document.dispatchEvent(
                new CustomEvent("FilePond:pluginloaded", { detail: Ie })
              ),
            Ie
          );
        })();
        ...
        !(function (e) {
          ...
          var t = function (e) {
                  ...
                  target: {
                    set: function (e) {
                      if (
                        ...
                        return (
                          (f = !0), (c = 0), d.onupdate(l), void d.oncomplete(l)
                        );
                      f = !1;
                    },
                    get: function () {
            ...
            ae = function (e) {
              ...
              return (
                ...
                (t.process = e.process || K(e) || e.url ? t.process : null),
              ...
              return (
                i(t, function (t) {
                  n[t] = {
                    ...
                    set: function (n) {
                      e.dispatch("SET_" + Ie(t, "_").toUpperCase(), {
                        value: n,
                      });
                    },
                  };
          ...
          var Ce = function (e, t) {
            ...
            Je = {
              ...
              labelInvalidField: ["Field contains invalid files", We.STRING],
              labelFileWaitingForSize: ["Waiting for size", We.STRING],
              labelFileSizeNotAvailable: ["Size not available", We.STRING],
              ...
              labelFileLoadError: ["Error during load", We.STRING],
              labelFileRemoved: ["Removed", We.STRING],
              labelFileRemoveError: ["Error during remove", We.STRING],
              labelFileProcessing: ["Uploading", We.STRING],
              labelFileProcessingComplete: ["Upload complete", We.STRING],
              labelFileProcessingAborted: ["Upload cancelled", We.STRING],
              labelFileProcessingError: ["Error during upload", We.STRING],
              ...
              labelButtonAbortItemProcessing: ["Cancel", We.STRING],
              labelButtonUndoItemProcessing: ["Undo", We.STRING],
              labelButtonRetryItemProcessing: ["Retry", We.STRING],
              ...
              styleButtonProcessItemPosition: ["right", We.STRING],
              styleLoadIndicatorPosition: ["right", We.STRING],
              styleProgressIndicatorPosition: ["right", We.STRING],
              styleButtonRemoveItemAlign: [!1, We.BOOLEAN],
              files: [[], We.ARRAY],
              credits: [["https://pqina.nl/", "Powered by PQINA"], We.ARRAY],
            },
            et = function (e, t) {
              return W(t)
                ? e[0] || null
            ...
            st = [Ve.LOADING, Ve.PROCESSING, Ve.PROCESSING_QUEUED, Ve.INIT],
            ...
            dt = function (e) {
              return (
                le(e.options.server) &&
                (le(e.options.server.process) || re(e.options.server.process))
              );
            },
            pt = function (e) {
              return {
                      ...
                      (t.request = e(
                        ...
                        function (e) {
                          (t.duration = Date.now() - t.timestamp),
                            (t.complete = !0),
                            e instanceof Blob && (e = Ot(e, e.name || It(n))),
                            a.fire(
                              "load",
            ...
            Bt = function (e, t, n) {
              ...
              return (
                ((Ut(n.method) ? a : a.upload).onprogress = function (e) {
                  ...
                  (c.onload = function (e) {
                    ...
                    o(
                      Vt(
                        "load",
                        e.status,
                        "HEAD" === t.method ? null : Ot(n(e.response), a),
                        r
                      )
                    );
                  }),
            ...
            jt = function (e, t, n, r, i, o, a, s, u, l, c) {
              ...
              var D = function () {
                ...
                S = function (e) {
                  return e.status === Wt.QUEUED || e.status === Wt.ERROR;
                },
                w = function (t) {
                  if (!_.aborted)
                    if ((t = t || f.find(S))) {
                      (t.status = Wt.PROCESSING), (t.progress = null);
                      var n =
                          p.ondata ||
                          function (e) {
                            return e;
                        ...
                        l = (t.request = Bt(
                          n(t.data),
                          o,
                          Object.assign({}, p, { headers: s })
                        ));
                      (l.onload = function () {
                        (t.status = Wt.COMPLETE), (t.request = null), P();
                      }),
                        ...
                        (l.onabort = function () {
                          (t.status = Wt.QUEUED), (t.request = null), u();
                        });
                    } else
                      f.every(function (e) {
                  ...
                  ? v(function (e) {
                      _.aborted ||
                        (f
                          ...
                          .forEach(function (e) {
                            (e.status = Wt.COMPLETE), (e.progress = e.size);
                          }),
                        P());
                    })
                  : T(function (e) {
              ...
              return function (i, o, a, s, u, l, c) {
                if (i) {
                  ...
                  if (i instanceof Blob && p)
                    return jt(e, t, n, i, o, a, s, u, l, c, r);
                  var E =
                      t.ondata ||
                      function (e) {
                        return e;
              ...
              var n = {
                ...
                i = function (t, i) {
                  var o = function () {
                    ...
                    a = function () {
                      (n.complete = !0),
                        l.fire("load-perceived", n.response.body);
                    };
                  l.fire("start"),
                    ...
                    (n.request = e(
                      ...
                      function (e) {
                        n.perceivedPerformanceUpdater.clear(),
                          l.fire(
                            "error",
                            le(e) ? e : { type: "error", code: 0, body: "" + e }
                          );
                      },
                      function (e, t, r) {
                        (n.duration = Date.now() - n.timestamp),
              ...
              var e =
                    ...
                    i.file
                      ...
                      : ((i.file = en(t)),
                        ...
                        n.on("meta", function (t) {
                          (i.file.size = t.size),
                            ...
                            t.source &&
                              ...
                              (i.status = Ve.PROCESSING_COMPLETE)),
                            l("load-meta");
                        }),
                        ...
                        n.on("load", function (t) {
                          i.activeLoader = null;
                          var n = function (t) {
                              (i.file = tn(t) ? t : i.file),
                                e === qe.LIMBO && i.serverFileReference
                                  ? u(Ve.PROCESSING_COMPLETE)
                                  : u(Ve.IDLE),
                                l("load");
                            },
                            o = function (e) {
                ...
                m = function e(t, n) {
                  if (i.processingAborted) i.processingAborted = !1;
                    ...
                    (u(Ve.PROCESSING), (a = null), i.file instanceof Blob)
                  ) {
                ...
                v = function (e, t, n) {
                  ...
                  r.forEach(function (e) {
                    ...
                    JSON.stringify(a[o]) !== JSON.stringify(t) &&
                      ((a[o] = t),
            ...
            hn = function (e, t) {
              return function () {
                ...
                l
                  ? t(l, o, s, u || {})
                  : s({ error: Vt("error", 0, "Item not found"), file: null });
              };
            },
            _n = function (e, t, n) {
              return {
                    ...
                    (n.itemUpdateTimeout = setTimeout(function () {
                      ...
                      if (t("IS_ASYNC")) {
                        ...
                        var s = function () {
                          ...
                          u = function (e) {
                            r.revert(
                              Zt(n.options.server.url, n.options.server.revert),
                              t("GET_FORCE_REVERT")
                            )
                              .then(e ? s : function () {})
                              .catch(function () {});
                        ...
                        return r.status === Ve.PROCESSING_COMPLETE
                          ? u(n.options.instantUpload)
                          : r.status === Ve.PROCESSING
                          ? l(n.options.instantUpload)
                          : void (n.options.instantUpload && s());
                      }
                ...
                MOVE_ITEM: function (e) {
                  ...
                  if (i) {
                    ...
                    o !== (r = ht(r, 0, n.items.length - 1)) &&
                      n.items.splice(r, 0, n.items.splice(o, 1)[0]);
                  }
                },
                SORT: function (r) {
                  var i = r.compare;
                ...
                ADD_ITEMS: function (n) {
                  ...
                  var p = t("GET_IGNORED_FILES"),
                    E = function (e) {
                      return tn(e) ? !p.includes(e.name.toLowerCase()) : !W(e);
                    },
                ...
                ADD_ITEM: function (r) {
                  var i = r.source,
                    ...
                    p = void 0 === d ? {} : d;
                  if (W(i))
                    f({ error: Vt("error", 0, "No source"), file: null });
                  else if (
                    !tn(i) ||
                    !n.options.ignoredFiles.includes(i.name.toLowerCase())
                  ) {
                    if (!Et(n)) {
                      if (
                      ...
                      var h = nt(n.items)[0];
                      if (
                        h.status === Ve.PROCESSING_COMPLETE ||
                        h.status === Ve.PROCESSING_REVERT_ERROR
                      ) {
                    ...
                    g.on("init", function () {
                      ...
                      g.on("load", function () {
                        ...
                        He("DID_LOAD_ITEM", g, { query: t, dispatch: e })
                          .then(function () {
                      ...
                      g.on("process-revert-error", function (t) {
                        e("DID_THROW_ITEM_PROCESSING_REVERT_ERROR", {
                          ...
                          error: t,
                          status: {
                            main: cn(n.options.labelFileProcessingRevertError)(
                              t
                            ),
                            sub: n.options.labelTapToRetry,
                          },
                ...
                REQUEST_PREPARE_OUTPUT: function (e) {
                  var n = e.item,
                    ...
                    i = e.failure,
                    o = void 0 === i ? function () {} : i,
                    a = { error: Vt("error", 0, "Item not found"), file: null };
                  if (n.archived) return o(a);
                  He("PREPARE_OUTPUT", n.file, { query: t, item: n }).then(
                    function (e) {
                ...
                REQUEST_ITEM_PROCESSING: hn(n, function (r, i, o) {
                  if (r.status === Ve.IDLE || r.status === Ve.PROCESSING_ERROR)
                    ...
                    r.status === Ve.PROCESSING_COMPLETE ||
                    r.status === Ve.PROCESSING_REVERT_ERROR
                      ? r
                          .revert(
                            Zt(n.options.server.url, n.options.server.revert),
                            t("GET_FORCE_REVERT")
                  ...
                  if (t("GET_ITEMS_BY_STATUS", Ve.PROCESSING).length !== a) {
                    if (r.status !== Ve.PROCESSING) {
                      ...
                      r.onOnce("process-complete", function () {
                        ...
                        t("GET_ITEMS_BY_STATUS", Ve.PROCESSING_COMPLETE)
                      ...
                      r.process(
                        $t(
                          Xt(u.server.url, u.server.process, u.name, {
                        ...
                        function (n, i, o) {
                          He("PREPARE_OUTPUT", n, { query: t, item: r })
                            .then(function (t) {
                              e("DID_PREPARE_OUTPUT", { id: r.id, file: t }),
                                i(t);
                            })
                            .catch(o);
                        }
                ...
                REMOVE_ITEM: hn(n, function (r, i, o, a) {
                  var s = function () {
                    ...
                    u = n.options.server;
                  r.origin === qe.LOCAL && u && re(u.remove) && !1 !== a.remove
            ...
            wn = function (e) {
              ...
              i && !r
                ? ((n.isDisabled = !0), a(t.element, "disabled", "disabled"))
                : !i &&
                  r &&
                ...
                r =
                  null === n.progress
                    ...
                    : t.query("GET_LABEL_FILE_LOADING") +
                      ...
                      "%";
              Tn(t.ref.main, r),
                Tn(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"));
            },
            Bn = function (e) {
              var t = e.root,
                n = e.action,
            ...
            Vn = function (e) {
              var t = e.root;
              Tn(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING")),
                Tn(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"));
            },
            qn = function (e) {
              var t = e.root;
              Tn(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_ABORTED")),
                Tn(t.ref.sub, t.query("GET_LABEL_TAP_TO_RETRY"));
            },
            kn = function (e) {
              var t = e.root;
              Tn(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_COMPLETE")),
          ...
          var Xn,
            ...
            sr = function (e) {
              ...
              if (
                (f &&
                  ...
                  (or.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX = Qn)),
                d && s)
              ) {
                ...
                i(o, function (e, t) {
                  ...
                  p.includes(e) && n.appendChildView(r),
                    ...
                    r.on("click", function (e) {
                      e.stopPropagation(),
                        t.disabled || n.dispatch(t.action, { query: a });
                    }),
                    (n.ref["button" + e] = r);
                }),
                (n.ref.processingCompleteIndicator = n.appendChildView(
                  n.createChildView(ar)
                )),
            ...
            mr = function (e) {
              ...
              if (
                ((null !== t.ref.scalable && n.scalable === t.ref.scalable) ||
                  ((t.ref.scalable = !Z(n.scalable) || n.scalable),
                ...
                (t.ref.center.translateY = r.height),
                  (t.ref.center.scaleY = (o - r.height - i.height) / 100),
            ...
            Tr = { type: "spring", stiffness: 0.75, damping: 0.45, mass: 10 },
            vr = "spring",
            yr = {
            ...
            Rr = function (e) {
              ...
              if (
                ...
                (t.ref.panel = t.appendChildView(
                  t.createChildView(gr, { name: "item-panel" })
                )),
            ...
            wr = function (e, t, n) {
              if (n) {
                ...
                for (
                  var p = a.marginTop + a.marginBottom, E = a.height + p, h = 0;
                  h < i;
                  h++
                ) {
                  var _ = (h % l) * u,
            ...
            kr = function (e) {
              var t = e.root,
                n = e.props;
              (t.ref.list = t.appendChildView(t.createChildView(qr))),
            ...
            Zr = function (e) {
              ...
              (t.element.id = "filepond--browser-" + n.id),
                ...
                Jr({ root: t }),
                ei({ root: t, action: { value: t.query("GET_REQUIRED") } }),
                ti({
                  root: t,
            ...
            ni = function (e) {
              ...
              t.query("GET_TOTAL_ITEMS") > 0
                ...
                : (Hr(n, "name", !0, t.query("GET_NAME")),
                  ...
                  t.query("GET_REQUIRED") && Hr(n, "required", !0));
            },
            ri = function (e) {
              var t = e.root;
            ...
            ai = function (e) {
              ...
              a(r, "for", "filepond--browser-" + n.id),
                ...
                (t.ref.handleKeyDown = function (e) {
                  (e.keyCode === oi.ENTER || e.keyCode === oi.SPACE) &&
            ...
            yi = function (e) {
              var t = e.root,
                n = e.action,
                r =
                  !(t.query("GET_ITEM", n.id).origin === qe.LOCAL) &&
            ...
            Pi = ["jpg", "jpeg", "png", "gif", "bmp", "webp", "svg", "tiff"],
            bi = ["css", "csv", "html", "txt"],
            Ci = { zip: "zip|compressed", epub: "application/epub+zip" },
            Ni = function () {
              var e =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
            ...
            Bi = function (e) {
              return new Promise(function (t, n) {
                ki(e) ? Vi(zi(e)).then(t).catch(n) : t([e.getAsFile()]);
              });
            },
            Vi = function (e) {
              return new Promise(function (t, n) {
            ...
            $i = function (e) {
              var t = [],
                n = { dragenter: ro, dragover: io, dragleave: ao, drop: oo },
                r = {};
              i(n, function (n, i) {
                ...
                Gi(n).then(function (r) {
                  ...
                  t.some(function (t) {
                    ...
                    if (f)
                      if (eo(e, a)) {
                        if (((i = !0), null === t.state))
                          return (t.state = "enter"), void s(Zi(e));
                        if (((t.state = "over"), o && !f))
                          return void no(n, "none");
                        l(Zi(e));
                      } else
                        o && !i && no(n, "none"),
                          t.state && ((t.state = null), u(Zi(e)));
                    else no(n, "none");
                  });
                });
              };
                ...
                Gi(n).then(function (n) {
                  t.forEach(function (t) {
                    ...
                    if (((t.state = null), !r || eo(e, i)))
                      return s(n) ? void o(Zi(e), n) : a(Zi(e));
                  });
                });
              };
            },
            ...
            fo = function (e) {
              lo.includes(e) ||
                (lo.push(e),
                uo || ((uo = !0), document.addEventListener("paste", co)));
            },
            po = function (e) {
              Ce(lo, lo.indexOf(e)),
                0 === lo.length &&
                  (document.removeEventListener("paste", co), (uo = !1));
            },
            Eo = function () {
              var e = function (e) {
                  t.onload(e);
              ...
              if (yo(t)) {
                ...
                go.push(r.filename),
                  ...
                  (_o = setTimeout(function () {
                    vo(t, go.join(", "), t.query("GET_LABEL_FILE_ADDED")),
                      (go.length = 0);
                  }, 750));
              }
            },
            ...
            Co = function (e) {
              ...
              i &&
                ...
                (t.ref.panel = t.appendChildView(
                  t.createChildView(gr, { name: "panel-root" })
                )),
              ...
              t.query("GET_ALLOW_REORDER") &&
                a &&
                !o &&
                (t.element.addEventListener("touchmove", bo, { passive: !1 }),
            ...
            No = function (e) {
              ...
              if (
                ...
                var c = t.query("GET_PANEL_ASPECT_RATIO"),
                  ...
                  p = d === (f ? t.query("GET_MAX_FILES") || Po : 1),
                  E = r.find(function (e) {
                ...
                if (p && E) {
                  ...
                  p ||
                    ((s.opacity = 1), (s.translateX = 0), (s.translateY = 0));
                var _ = Go(t),
                  m = xo(t),
                ...
                if (
                  ((u.translateY =
                    Math.max(0, I - u.rect.element.marginTop) - _.top),
                  c)
                ) {
                  ...
                  y > i.cappedHeight && m.visual > x
                    ? (u.overflow = x)
                    : (u.overflow = null),
                    (t.height = Math.min(i.cappedHeight, R - _.top - _.bottom));
                } else {
            ...
            Vo = function (e) {
              ...
              if (r && !e.ref.hopper) {
                var i = so(
                  ...
                  function (t) {
                    ...
                    return (
                      ...
                      t.every(function (t) {
                        return (
                          Xe("ALLOW_HOPPER_ITEM", t, { query: e.query }).every(
                            function (e) {
                              return !0 === e;
                            }
                          ) && n(t)
                ...
                (i.onload = function (t, n) {
                  ...
                  He("ADD_ITEMS", t, { dispatch: e.dispatch }).then(function (
                    t
                  ) {
                    if (Uo(e, t)) return !1;
                  ...
                  (e.ref.hopper = i),
                  (e.ref.drip = e.appendChildView(e.createChildView(_i)));
              } else
                !r &&
                  e.ref.hopper &&
              ...
              i && !e.ref.browser
                ? (e.ref.browser = e.appendChildView(
                    e.createChildView(
                      ...
                      Object.assign({}, t, {
                        onload: function (t) {
                          He("ADD_ITEMS", t, { dispatch: e.dispatch }).then(
                            function (t) {
                              if (Uo(e, t)) return !1;
                              e.dispatch("ADD_ITEMS", {
                                items: t,
            ...
            zo = B({
              ...
              destroy: function (e) {
                ...
                t.ref.paster && t.ref.paster.destroy(),
                  ...
                  t.element.removeEventListener("touchmove", bo),
                  t.element.removeEventListener("gesturestart", bo);
              },
              ...
              var p = zo(i, { id: Oe() }),
                ...
                m = function (e) {
                  return function (t) {
                    ...
                    return (
                      t.items && (n.items = t.items.map(Ue)),
                ...
                b = function () {
                  ...
                  if (!r.length) {
                    var i = L().filter(function (e) {
                      return (
                        !(e.status === Ve.IDLE && e.origin === qe.LOCAL) &&
                        e.status !== Ve.PROCESSING &&
                        e.status !== Ve.PROCESSING_COMPLETE &&
                        e.status !== Ve.PROCESSING_REVERT_ERROR
                      );
                    });
            ...
            Ko = function (e) {
              ...
              Object.keys(i).forEach(function (e) {
                le(i[e])
                  ? (le(r[e]) || (r[e] = {}), Object.assign(r[e], i[e]))
                  : (r[e] = i[e]);
              }),
                  ...
                  init: function (e) {
                    return (
                      ...
                      (this.options.duration =
                        0 === e.duration
                          ? 0
                          : e.duration || t.defaults.duration),
                  ...
                  buildToast: function () {
                    ...
                    if (
                      ...
                      var s = n("x", this.options),
                        ...
                        c =
                          "toastify-top" == this.options.gravity ? u : "-" + u;
              ...
              (t.reposition = function () {
                for (
                  var e,
                    ...
                    n = { top: 15, bottom: 15 },
                    i = { top: 15, bottom: 15 },
                    o = document.getElementsByClassName("toastify"),
                    a = 0;
                  a < o.length;
                  a++
                ) {
