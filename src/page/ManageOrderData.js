...
const ManageOrderData = () => {
  ...
  const openModalSellar = async (sellerId) => {
    ...
    try {
      ...
      const selleresponse = await API.enquriys_sellerId(
        response.data.data[0].enquiryId,
        header
      );
                        ...
                        <tr key={index}>
                          ...
                          <td class="text-bold-500">
                            {item.seller[0].firstName +
                              " " +
                              item.seller[0].lastName}{" "}
                          </td>
                          <td>
                            <ul className="ps-0">
                              <li>
                                <strong>Product details : </strong>{" "}
                                {item.enquiry[0].product_des}
                              </li>
                              <li>
                                <strong>Quantities : </strong>{" "}
                                {item.enquiry[0].quantities}
                              </li>
                              <li>
                                <strong>Size : </strong> {item.enquiry[0].size}
                              </li>
                            </ul>
                          </td>
                          <td>
                          ...
                          <td>
                            <div class="buttons">
                              <span
                                onClick={() => openModalSellar(item._id)}
                                class="btn icon btn-primary"
                              >
                                <i class="bi bi-pencil"></i>
                              </span>
                              <button
                                onClick={() => menufactheDelete(item._id)}
